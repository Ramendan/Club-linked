Public Class MusicInfo
    Private Sub btnJoin_Click(sender As Object, e As EventArgs) Handles btnJoin.Click
        If Not String.IsNullOrEmpty(Main.ID) Then  ' Check for empty ID
            ...
            Try
                ...
                Main.cmd.CommandText = $"UPDATE Accounts SET music = 'member' WHERE userID = {Main.ID}"

                Main.cmd.ExecuteNonQuery()

                MsgBox("Joined music club")
                ...
                lblCount.Text = $"There are {GetClubMemberCount() + 1} people who are members of the music club."
    ...
    Private Sub btnLeave_Click(sender As Object, e As EventArgs) Handles btnLeave.Click
        If Not String.IsNullOrEmpty(Main.ID) Then  ' Check for empty ID
            ...
            Try
                ...
                Main.cmd.CommandText = $"UPDATE Accounts SET music = NULL WHERE userID = {Main.ID}"

                Main.cmd.ExecuteNonQuery()

                MsgBox("Left music club")
    ...
    Private Sub MusicInfo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        lblCount.Text = $"There are {GetClubMemberCount()} people who are members of the music club."
    End Sub
End Class