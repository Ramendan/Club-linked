    ...
    Private Sub btnJoin_Click(sender As Object, e As EventArgs) Handles btnJoin.Click
        If Not String.IsNullOrEmpty(Main.ID) Then  ' Check for empty ID
            ...
            Try
                ...
                Main.cmd.CommandText = $"UPDATE Accounts SET reading = 'member' WHERE userID = {Main.ID}"

                Main.cmd.ExecuteNonQuery()

                MsgBox("Joined reading club")
                ...
                lblCount.Text = $"There are {GetClubMemberCount() + 1} people who are members of the reading club."
