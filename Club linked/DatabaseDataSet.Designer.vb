...
Partial Public Class DatabaseDataSet
    ...
    Partial Public Class AccountsDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddAccountsRow(ByVal userID As Integer, ByVal username As String, ByVal password As String) As AccountsRow
...
Namespace DatabaseDataSetTableAdapters
    ...
    Partial Public Class AccountsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Accounts] ([userID], [username], [password]) VALUES (@userID, "& _ 
                "@username, @password);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT userID, username, password FROM Accounts WHERE (u"& _ 
                "serID = @userID)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Accounts] SET [userID] = @userID, [username] = @username, [password"& _ 
                "] = @password WHERE (([userID] = @Original_userID) AND ([username] = @Original_u"& _ 
                "sername) AND ([password] = @Original_password));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT userID, username, passw"& _ 
                "ord FROM Accounts WHERE (userID = @userID)"
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT userID, username, password FROM dbo.Accounts"
